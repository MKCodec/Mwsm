...
$(document).on('click', '.btn-emoji', (event) => {
	...
	$.ajax({
		...
		url: "/emoji",
		data: {
			find: $(event.target).attr('data-code'),
			in: 'key',
			out: 'emoji'
		},
...
function InsertEmotion(Emoji) {
	$('.modal').fadeOut('fast');
	if ($("#Message").is(":visible")) {
		$('#Message').val($('#Message').val() + Emoji).focus();
	}
	if ($("#MSG_A01").is(":visible")) {
		$('#MSG_A01').val($('#MSG_A01').val() + Emoji).focus();
	}
	if ($("#MSG_A02").is(":visible")) {
		$('#MSG_A02').val($('#MSG_A02').val() + Emoji).focus();
	}
	if ($("#MSG_A03").is(":visible")) {
		$('#MSG_A03').val($('#MSG_A03').val() + Emoji).focus();
	}
	if ($("#MSG_B01").is(":visible")) {
		$('#MSG_B01').val($('#MSG_B01').val() + Emoji).focus();
	}
	if ($("#MSG_B02").is(":visible")) {
		$('#MSG_B02').val($('#MSG_B02').val() + Emoji).focus();
	}
	if ($("#MSG_B03").is(":visible")) {
		$('#MSG_B03').val($('#MSG_B03').val() + Emoji).focus();
	}
	if ($("#MSG_C01").is(":visible")) {
		$('#MSG_C01').val($('#MSG_C01').val() + Emoji).focus();
	}
	if ($("#MSG_C02").is(":visible")) {
		$('#MSG_C02').val($('#MSG_C02').val() + Emoji).focus();
	}
	if ($("#MSG_C03").is(":visible")) {
		$('#MSG_C03').val($('#MSG_C03').val() + Emoji).focus();
	}
	if ($("#MSG_D01").is(":visible")) {
		$('#MSG_D01').val($('#MSG_D01').val() + Emoji).focus();
	}
	if ($("#MSG_D02").is(":visible")) {
		$('#MSG_D02').val($('#MSG_D02').val() + Emoji).focus();
	}
	if ($("#MSG_D03").is(":visible")) {
		$('#MSG_D03').val($('#MSG_D03').val() + Emoji).focus();
	}
	if ($("#MSG_E01").is(":visible")) {
		$('#MSG_E01').val($('#MSG_E01').val() + Emoji).focus();
	}
	if ($("#MSG_E02").is(":visible")) {
		$('#MSG_E02').val($('#MSG_E02').val() + Emoji).focus();
	}
	if ($("#MSG_E03").is(":visible")) {
		$('#MSG_E03').val($('#MSG_E03').val() + Emoji).focus();
	}
	if ($("#MSG_F01").is(":visible")) {
		$('#MSG_F01').val($('#MSG_F01').val() + Emoji).focus();
	}
	if ($("#MSG_F02").is(":visible")) {
		$('#MSG_F02').val($('#MSG_F02').val() + Emoji).focus();
	}
	if ($("#MSG_F03").is(":visible")) {
		$('#MSG_F03').val($('#MSG_F03').val() + Emoji).focus();
	}
	if ($("#MSG_G01").is(":visible")) {
		$('#MSG_G01').val($('#MSG_G01').val() + Emoji).focus();
	}
	if ($("#MSG_G02").is(":visible")) {
		$('#MSG_G02').val($('#MSG_G02').val() + Emoji).focus();
	}
	if ($("#MSG_G03").is(":visible")) {
		$('#MSG_G03').val($('#MSG_G03').val() + Emoji).focus();
	}
	if ($("#MSG_H01").is(":visible")) {
		$('#MSG_H01').val($('#MSG_H01').val() + Emoji).focus();
	}
	if ($("#MSG_H02").is(":visible")) {
		$('#MSG_H02').val($('#MSG_H02').val() + Emoji).focus();
	}
	if ($("#MSG_H03").is(":visible")) {
		$('#MSG_H03').val($('#MSG_H03').val() + Emoji).focus();
	}
	if ($("#MSG_I01").is(":visible")) {
		$('#MSG_I01').val($('#MSG_I01').val() + Emoji).focus();
	}
	if ($("#MSG_I02").is(":visible")) {
		$('#MSG_I02').val($('#MSG_I02').val() + Emoji).focus();
	}
	if ($("#MSG_I03").is(":visible")) {
		$('#MSG_I03').val($('#MSG_I03').val() + Emoji).focus();
	}
	if ($("#MSG_J01").is(":visible")) {
		$('#MSG_J01').val($('#MSG_J01').val() + Emoji).focus();
	}
	if ($("#MSG_J02").is(":visible")) {
		$('#MSG_J02').val($('#MSG_J02').val() + Emoji).focus();
	}
	if ($("#MSG_J03").is(":visible")) {
		$('#MSG_J03').val($('#MSG_J03').val() + Emoji).focus();
	}
	if ($("#MSG_K01").is(":visible")) {
		$('#MSG_K01').val($('#MSG_K01').val() + Emoji).focus();
	}
	if ($("#MSG_K02").is(":visible")) {
		$('#MSG_K02').val($('#MSG_K02').val() + Emoji).focus();
	}
	if ($("#MSG_K03").is(":visible")) {
		$('#MSG_K03').val($('#MSG_K03').val() + Emoji).focus();
	}
}
...
$(document).ready(function() {
	$("#HASHTABLE, #HASHTABLESCHED").tooltip({
		selector: '[data-toggle=tooltip]',
		position: {
			my: 'left center',
			at: 'right center'
		...
		if ($("#tabs-2E1").is(":visible")) {
			...
			$("#tabs-2E3, .isControls").fadeOut("slow", function() {
				...
				$("#tabs-2E4").fadeIn("slow", function() {
					if (OnClick) {
						OnClick = false;
						if ($(".FireX").parent().length == 0) {
							$.ajax({
								type: "POST",
								url: "/scheduler_mkauth",
								data: {
									scheduler: 'true'
								},
								beforeSend: function(data) {
								...
								success: function(data) {
									if (data.Status == "Fail") {
										setTimeout(() => {
											$(".isLoader").fadeOut("slow", function() {
												setTimeout(() => {
													$("#isSCHED, .isWaitSCHED").fadeIn("fast", function() {
														$(".Reset").removeClass("fa-spin").addClass("change").prop('disabled', false);
							...
							if (data.Status == "Fail") {
								...
								$.jGrowl('<i class="fa ' + Icon + '" aria-hidden="true"></i> ' + data.Return, {
									...
									close: function(e, m, o) {
										$(".Reset").removeClass("fa-spin").addClass("change").prop('disabled', false);
										$(".isWait").text("Waiting Select Options...");
										$("#isYear, #isMonth, #isSearch, #003").prop('disabled', false);
										$(".isBoot").fadeOut("slow", function() {
											$(".isWait").fadeIn("slow", function() {
						...
						error: function(request, status, error) {
							...
							$.jGrowl('<i class="fa ' + Icon + '" aria-hidden="true"></i> ' + 'Failed: Server connection error', {
								...
								close: function(e, m, o) {
									...
									$(".isWait").text("Waiting Select Options...");
									$("#isYear, #isMonth, #isSearch, #003").prop('disabled', false);
									$("#isTable, .isWait").fadeIn("slow", function() {
...
$(document).ready(function() {
	...
	$("#isYear").on('change', function() {
		...
		if ($(this).val() == "0") {
			$("#isMonth").val(Now).change();
		}
		if ($(this).val() == "1") {
			$("#isMonth").val("12").change();
		}
	});
	...
	$("#Message").on('focusin', function() {
		$("#SendClear, .SendEmoji").fadeIn("slow", function() {
	...
	$("#Message").on('focusout', function() {
		if ($("#Message").val() == "") {
			$("#SendClear, .SendEmoji").fadeOut("slow", function() {

			});
		}
	});

	$(".MSG_Box").on('focusin', function() {
		$(".SendEmoji").fadeIn("slow", function() {

		});
	});

	$(".MSG_Box").on('focusout', function() {
		if ($(".MSG_Box").val() == "") {
			$(".SendEmoji").fadeOut("slow", function() {
	...
	$("#WhatsApp").on('input propertychange keyup', function() {
	...
	$("#token").on("input propertychange", function() {
		...
		if (Keygen.length >= 7) {
			$.ajax({
				...
				beforeSend: function(data) {
					$("#token, .Reset").prop('disabled', true);
					$(".loader_trak").fadeIn("slow", function() {
						$(".Reset").removeClass("change").addClass("fa-spin").prop('disabled', true);
					});
					...
					$.jGrowl('<i class="fa ' + Icon + '" aria-hidden="true"></i> ' + data.Return, {
						...
						close: function(e, m, o) {
							...
							if (data.Status == "Fail") {
								...
								$(".loader_trak").fadeOut("slow", function() {
									$(".Reset").removeClass("fa-spin").addClass("change").prop('disabled', false);
								});
	...
	socket.on('Emoji', function(value) {
		...
		(data.d).sort(function(a, b) {
			var Nome = a.NAME.localeCompare(b.NAME);
			var Ordem = parseFloat(a.ID) - parseFloat(b.ID);
			return Ordem || Nome;
		});

		for (var i = 0; i < data.d.length; i++) {
			html += '<button type="button" class="btn btn-light btn-emoji" data-code="' + data.d[i].KEY + '">' + data.d[i].HTML + '</button>';
		}

		$('#isEmoticons').first().after(html);
	});


	socket.on('shedullers', function(value) {
		if (value.length >= 1) {
			$(".isWaitSCHED").fadeOut("slow", function() {
				if ($(".FireX:visible").parent().length >= 1) {
					FadeIn = "#MkSendSCHED";
				} else {
					FadeIn = "#isSCHED";
				}
				$(FadeIn).fadeIn("slow", function() {
					...
					(data.d).sort(function(a, b) {
						...
						var Ordem = parseFloat((new Date(a.REWARD).toLocaleString("pt-br").split(",")[0]).split("/")[0]) - parseFloat((new Date(b.REWARD).toLocaleString("pt-br").split(",")[0]).split("/")[0]);
						return Ordem || Nome;
					});

					$('#HASHTABLESCHED tr').empty();
					for (var i = 0; i < data.d.length; i++) {
						Cursor = "default";
						html += '<tr class="FireX Shed_' + data.d[i].TITLE + '" style="cursor: ' + Cursor + ';">';
						html += '<td class="text-center tbrajust">' + data.d[i].TITLE + '</td>';
						html += '<td class="text-center tbreward">' + new Date(data.d[i].REWARD).toLocaleString("pt-br").split(",")[0] + '</td>';
						html += '<td class="text-center tbclient">' + toCapitalize(data.d[i].CLIENT) + '</td>';
						html += '</tr>';
					}
					$('#HASHTABLESCHED tr').first().after(html);

					$("#MkSendSCHED, #isSCHED").fadeOut("slow", function() {
						$(".Reset").removeClass("fa-spin").addClass("change").prop('disabled', false);
						$("#001").prop('disabled', false);
					});
				});
			...
			$(".isLoader").fadeOut("slow", function() {
				$("#isSCHED, .isWaitSCHED").fadeIn("slow", function() {
					$(".Reset").removeClass("fa-spin").addClass("change").prop('disabled', false);
					$("#001").prop('disabled', false);
				});
			});
	...
	socket.on('schedresume', function(data) {
		if (data == 'true') {
			$(".isLoader").hide();
			$("#isSCHED, .isWaitSCHED").fadeIn("slow", function() {
				$(".FireX").remove();
			});
		} else if ($(".FireX:visible").parent().length >= 1) {
			$("#MkSendSCHED").fadeIn("slow", function() {
				$(".Shed_" + data.toString()).fadeOut("slow", function() {
					$(".Shed_" + data.toString()).remove();
					$("#MkSendSCHED, .isLoader").fadeOut("slow", function() {
						if ($(".FireX:visible").parent().length == 0) {
							$("#isSCHED, .isWaitSCHED").fadeIn("slow", function() {
			...
			$("#isSCHED, .isWaitSCHED").fadeIn("slow", function() {
				$("#MkSendSCHED, .Shed_" + data.toString()).hide();
				$(".Shed_" + data.toString()).remove();
			});
		}
	});
	...
	socket.on('isyear', function(data) {
		$('#YearBack').text(data - 1);
		$('#YearNow').text(data);
		$('#isYear').val(0).change();
	});
	...
	socket.on('backup', function(data) {
		switch (data) {
			case 'true':
				...
				if ($("#AutoBot").is(":checked")) {
					$("#FBackup").prop("disabled", true).attr('disabled');
				} else {
					$("#FBackup").prop("disabled", false).removeAttr('disabled');
				}
				break;
			case 'false':
	...
	socket.on('doublekill', function(data) {
		switch (data) {
			case 'true':
				$("#DoubleKill").prop("checked", true);
				break;
			case 'false':
				$("#DoubleKill").prop("checked", false);
				break;
		}
	});
...
$(document).ready(function() {
	...
	(function($) {
		$.fn.Server = function(element) {
			var textToCopy = $(element).text();
			var tempTextarea = $('<textarea>');
			$('body').append(tempTextarea);
			tempTextarea.text(textToCopy).select();
			document.execCommand('copy');
			tempTextarea.remove();
			return this;
		};
	...
	$('#ButtonSRV').on({
		"click": function() {
			$(this).Server("#SRVCode");
			$(".SRVCode").removeClass("fa-clone").addClass("fa-check").prop('disabled', true);
			$(".SRVCode").fadeIn("fast", function() {
				$(this).tooltip({
					effect: "blind",
					duration: 1000,
					content: 'Copyed!',
					...
					disabled: true,
					close: function(event, ui) {
						$(".SRVCode").fadeOut("fast", function() {
							$(".SRVCode").removeClass("fa-check").addClass("fa-clone").prop('disabled', false);
							$(".SRVCode").fadeIn("fast", function() {
								$(this).tooltip('disable');
							});
						});
...
$(document).ready(function() {
	...
	$("#Reset").on("click", function() {
		...
		$.ajax({
			...
			beforeSend: function(data) {
				$(".loader_trak").fadeOut("fast", function() {
					$(".Reset").removeClass("change").addClass("fa-spin").prop('disabled', true);
				});
			},
			success: function(data) {
	...
	$("#FBackup").on('click', function() {
		$.ajax({
			...
			beforeSend: function(data) {
				$(".Reset").removeClass("change").addClass("fa-spin").prop('disabled', true);
				$("#FBackup").prop('disabled', true).attr('disabled');
				$("#WaitingFB").fadeIn("slow", function() {
			...
			success: function(data) {
				if (data.Status != undefined) {
					...
					$("#WaitingFB").fadeOut("slow", function() {
						$("#FBackup").prop('disabled', false).removeAttr('disabled');
						$.jGrowl('<i class="fa ' + Icon + '" aria-hidden="true"></i> ' + data.Return, {
							header: '<div style="font-size:12px;"><i class="fa fa-cogs" aria-hidden="true"></i> Server:<div/>',
							life: 2000,
			...
			error: function(request, status, error) {
				$("#WaitingFB").fadeOut("slow", function() {
					$("#FBackup").prop('disabled', false).removeAttr('disabled');
					$.jGrowl('<i class="fa fa-exclamation" aria-hidden="true"></i> Failed to Load Data', {
						header: '<div style="font-size:12px;"><i class="fa fa-cogs" aria-hidden="true"></i> Server:<div/>',
						life: 2000,
						theme: 'Mwsm',
						speed: 'slow',
	...
	$("#AutoBot").on('change', function() {
		if ($("#module").is(":checked") && $("#AutoBot").is(":checked")) {
			$("#backup, #Spam, #SpamOut, #MinTime, #MaxTime, #Shift, .MSG_Box, .Control, #FBackup").prop("disabled", true);
			$("#Zero, #InSave").prop('disabled', true).attr('disabled');
			$('#Manager').text("Mwsm");
			$('.Protects').show();
			Aimbot = true;
			...
			$('#Manager').text("MkAuth");
			$("#Zero, #InSave").prop('disabled', false).removeAttr('disabled');
			$("#backup, #Spam, #Shift, .MSG_Box, .Control, #FBackup").prop("disabled", false);
			if ($("#Spam").is(":checked")) {
				$("#SpamOut").prop('disabled', false);
			} else {
				$("#SpamOut").prop('disabled', true);
